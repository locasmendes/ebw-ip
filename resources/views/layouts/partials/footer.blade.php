<footer id="footer" class="bg-ebw-dark text-white">
    <div class="d-flex flex-column pt-7">
        <div class="bg-ebw-golden">
            <div class="container">
                <div class="row justify-content-between">
                    <div class="brands-container d-flex align-items-center w-auto">
                        <div class="ebw-brand">
                            <img role="img" class="ebw-invest-logo-mono" src="{{ asset('assets/svg/ebw-invest-logo.svg') }}">
                        </div>
                        <div class="xp-brand">
                            <img role="img" class="xp-logo-mono" src="{{ asset('assets/svg/xp-agent-logo.svg') }}">
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row justify-content-between py-9">
                ...
                <div class="col-12 col-md-4">
                    <h2 class="fw-bold">Deixe sua dúvida!</h2>
