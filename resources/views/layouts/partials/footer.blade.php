<footer id="footer" class="bg-ebw-dark text-white">
    <div class="d-flex flex-column pt-7">
        ...
        <div class="d-flex flex-md-row flex-column justify-content-center text-center">
            <small class="text-center" style="font-size: 10px;color: #ffffff8c;">
                <p>
                    A EBW INVEST AGENTE AUTONOMO DE INVESTIMENTOS LTDA  é uma empresa de agentes autônomos de investimento devidamente registrada na Comissão de Valores Mobiliários (CVM), na forma da Instrução Normativa nº497/11. A EBW INVEST AGENTE AUTONOMO DE INVESTIMENTOS LTDA  atua no mercado  financeiro credenciada à XP Investimentos CCTVMS/A, o que pode ser verificado através do site da CVM (www.cvm.gov.br> Informações de Regulados> Agentes Autônomos>Consulta a Informações de Agentes Autônomos> EBW INVEST AGENTE AUTONOMO DE INVESTIMENTOS LTDA) ou através do site da ANCORD para escritórios credenciados a partir de outubro de 2012 (http://www.ancord.org.br>Associados>AgentesAutônomosdeInvestimento) ou através do site da própria XP Investimentos CCTVMS/A (www.xpi.com.br>SobreaXP>Encontreumescritório>Selecione o estado e a cidade que deseja pesquisar>Veja a lista dos Agentes Autônomos). Na forma da legislação da CVM, o Agente Autônomo de Investimento não pode administrar ou gerir o patrimônio de investidores. O Agente Autônomo é um intermediário e depende da autorização prévia do cliente para realizar operações no mercado financeiro. Esta mensagem e seus anexos contém informações confidenciais destinadas a indivíduo e propósito específicos, sendo protegida por lei. Caso você não seja a pessoa a quem foi dirigida a mensagem, deve apaga- la. É terminantemente proibida a utilização, acesso, cópia ou divulgação não autorizada das informações presentes nesta mensagem. As informações contidas nesta mensagem e em seus anexos são de responsabilidade do seu autor, não representando necessariamente ideias, opiniões, pensamentos ou qualquer forma de posicionamento por parte da EBW INVEST AGENTE AUTONOMO DE INVESTIMENTOS. O investimento em ações é um investimento de risco e rentabilidade passada não é garantia de rentabilidade futura. Na realização de operações com derivativos existe a possibilidade de perdas superiores aos valores investidos, podendo resultar em significativas perdas patrimoniais.  Para informações e dúvidas, favor contatar seu Agente Autônomo de Investimentos. Para reclamações, favor contatar a Ouvidoria da XP Investimentos no telefone nº 0800–722–3730.
             </p>
            </small>
            @auth
                <small class="px-5">
