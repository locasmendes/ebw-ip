...
@section('main')
    <div class="home-page">
        <div class="d-flex flex-column">
            ...
            <section class="transition-section pb-md-5 pe-md-5 ps-md-5 pt-md-7 bg-white text-black">
            ...
            <section class="hero-calls d-flex flex-column flex-md-row justify-content-evenly text-white p-5" style="background: url({{url('assets/png/calls-specs/EBW2.png')}});">
